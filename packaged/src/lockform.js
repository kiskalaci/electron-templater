    ...
    if (pageDictionary.exists('Annots')) {
        ...
        for (var i = 0; i < annotationsArray.getLength(); ++i) {
            ...
            if (isWidget) {
                ...
                if (nAppearances.getType() === muhammara.ePDFObjectDictionary) {
...
function lockWidgetAnnotationsForPage(handles, pageObjectId, pageDictionary, widgetAnnotatons) {
    ...
    if (pageDictionary.exists('Contents')) {
        ...
        if (contents.getType() === muhammara.ePDFObjectStream) {
        ...
        else if (contents.getType() === muhammara.ePDFObjectArray) {
...
function removeForm(handles) {
    ...
    if (!!acroformInCatalog && (acroformInCatalog.getType() === muhammara.ePDFObjectIndirectObjectReference)) {
